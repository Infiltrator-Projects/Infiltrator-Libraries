...
static const InfiltratrTemporalClockModeInfo temporal_clock_modes[] = {
    ...
    { "solar", "Apparent solar time (true Sun)", true, false, true },
    ...
    { "chinese-ke", "Chinese hundred-kè day (100 equal kè)", false, false, false },
    { "roman-temporal", "Roman seasonal time (12 daylight hours / 4 night watches)", false, true, true },
    { "japanese-temporal", "Edo Japanese unequal hours (6 day / 6 night)", false, true, true },
    ...
    { "indian-ghati", "Indian ghaṭī time (60 ghaṭī per sunrise day)", false, true, true },
