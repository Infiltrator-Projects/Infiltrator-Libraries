...
This directory is the canonical documentation entry point for Common. The Infiltrator project family uses the same baseline document roles in every repository so readers can move between projects without relearning the structure.
...
- USAGE.md — specialist or historical detail retained alongside the canonical baseline.
- design/README.md — specialist or historical detail retained alongside the canonical baseline.
- design/CONSUMERS.md — specialist or historical detail retained alongside the canonical baseline.
- docs/I18N.md — specialist or historical detail retained alongside the canonical baseline.
