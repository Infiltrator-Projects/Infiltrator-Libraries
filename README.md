...
`portable` build contains those five modules only. `src/dynlib.c` is a thin
POSIX/Win32 runtime-loader adapter; `src/posix.c` is the Linux/POSIX file, path
and monotonic-clock provider.
